...
class F { constructor(i,j,k,t,image, tx, r = 0, g = 150, b = 255, a = 255, d) {
    Object.assign(this, {i:i, j:j, k:k, t:t || [new T,new T,new T], image:image, rgba:`rgba(${r},${g},${b},${a})`, d:d, tx:'null'})}}
